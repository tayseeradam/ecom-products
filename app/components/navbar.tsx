...
//       <div className="container my-auto flex items-center justify-between px-4 py-4">
...
//             {cartCount > 0 && <span className="absalut -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded">{cartCount}</span>}
//           </Link>
